  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-cream-50 px-4">
      <div className="text-center max-w-md">
        ...
        <h1 className="text-3xl md:text-4xl font-serif font-bold text-charcoal-800 mb-4">
          Thanks! Lauren will be in touch soon.
        </h1>
        <p className="text-charcoal-700 mb-8">
          Follow along on social media for cleaning tips and transformations.
        </p>
        ...
        <Link
          href="/"
          className="inline-block bg-sage-500 text-white px-8 py-3 rounded-full font-semibold hover:bg-sage-600 transition-colors"
        >
          Back to Home
        </Link>
      </div>
