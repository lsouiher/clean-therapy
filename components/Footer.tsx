    ...
    <footer className="bg-charcoal-800 text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-serif text-xl font-bold mb-2">
              Clean Therapy <span className="text-sage-400">by Lauren</span>
            </h3>
            <p className="text-white/60 text-sm">Clean Home, Clear Mind.</p>
          </div>
          ...
          <div>
            ...
            <a
              href="tel:2169065283"
              className="block text-lg font-bold text-sage-400 hover:text-sage-300 transition-colors mb-2"
            >
              216-906-5283
            </a>
            <p className="text-sm text-white/60 mb-4">
              Serving Greater Cleveland, Ohio
            </p>
        ...
        <div className="border-t border-white/10 mt-10 pt-6 text-center text-xs text-white/40">
          &copy; 2025 Clean Therapy by Lauren. All rights reserved.
        </div>
      </div>
    </footer>
  );
